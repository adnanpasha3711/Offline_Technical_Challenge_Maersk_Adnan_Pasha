import os
from graph_loader import load_graph, write_results
...
write_results(result_a, "a_sp_between_two_nodes.json", mode="sp_between_two_nodes", source=source, target=target)
...
write_results(result_b, "b_sp_to_target_node.json", mode="sp_to_target_node", target=target)
...
write_results(result_c, "c_sp_from_source.json", mode="sp_from_source", source=source)
...
write_results(result_d, "d_sp_between_all_pairs.json", mode="sp_between_all_pairs")